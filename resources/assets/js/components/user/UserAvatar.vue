    ...
    export default {
        ...
        methods:{
            ...
            saveClicked(){
                ...
                console.log(img);
                axios.post('/api/user/avatar', {image: img, id: this.$store.getters.currentUser.id})
                    .then(res=>{
